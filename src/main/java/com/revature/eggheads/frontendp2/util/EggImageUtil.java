...
public final class EggImageUtil {
    ...
    public static BufferedImage generateEggImage(
                                        ...
                                        String sizeS,
                                        String redS, String greenS, String blueS) throws IOException, BackendParameterOutOfBoundsException {
     ...
     * @param green 0-255
     * @param blue 0-255
     * @throws BackendParameterOutOfBoundsException
     */
    public static void areParametersOutOfBounds(int size,
                                                int red, int green, int blue) throws BackendParameterOutOfBoundsException {
        if(size < 0 || size > 100 ||
                red < 0 || red > 255 ||
                green < 0 || green > 255 ||
                blue < 0 || blue > 255){
            throw new BackendParameterOutOfBoundsException("One of the egg parameters is out of bounds");
        }
    }
}
